...
from data_loader import split_quantity_interval, load_data
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients = split_quantity_interval(metadata, int(NUM_CLIENTS/2))
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 5 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_5.txt', help='Path to save the results')
