...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_feature("Sex", data_folderpath, NUM_CLIENTS, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 7 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_7.txt', help='Path to save the results')
