...
from data_loader import load_data, split_feature
...
def main(args):
    ...
    NUM_CLIENTS = args.num_clients # choose num_client > #num_race_classes
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_feature("Race", data_folderpath, NUM_CLIENTS, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 8 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--seeds', type=int, nargs='+', default=[42], help='List of seeds for experiments')
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_8.txt', help='Path to save the results')
