###########################################
# EXPERIMENTS 14: Label: percentage
...
from data_loader import load_data, split_quantity_label_percentage
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_quantity_label_percentage(data_folderpath, NUM_CLIENTS, PERC, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 14 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_14.txt', help='Path to save the results')
