...
from data_loader import load_data, split_quantity_label
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_quantity_label(data_folderpath, NUM_CLIENTS, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 10 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_10.txt', help='Path to save the results')
