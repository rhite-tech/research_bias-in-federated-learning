###########################################
# EXPERIMENTS 12: FEATURE + QUANTITY: race
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_quantity_feature("Race", data_folderpath, NUM_CLIENTS, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 12 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_12.txt', help='Path to save the results')
