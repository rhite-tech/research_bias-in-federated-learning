...
from data_loader import split_quantity_equal, load_data 
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients = split_quantity_equal(NUM_CLIENTS, CLIENT_SIZES, data_folderpath, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 1 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--client_size', type=int, default=36000, help='Size of each client')
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_1.txt', help='Path to save the results')
