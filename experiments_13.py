###########################################
# EXPERIMENTS 13: FEATURE + QUANTITY: marital status
...
from data_loader import load_data, split_quantity_feature
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_quantity_feature("Marital Status", data_folderpath, NUM_CLIENTS, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 13 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_13.txt', help='Path to save the results')
