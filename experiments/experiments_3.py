...
from data_loader import original_split, load_data
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 3 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_3.txt', help='Path to save the results')
