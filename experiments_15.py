###########################################
# EXPERIMENTS 15: Feature: Sex, percentage
# with quantity heterogeneity
###########################################
...
from data_loader import load_data, split_quantity_feature_percentage
...
def main(args):
    ...
    for SEED in SEEDS:
        ...
        clients, len_clients = split_quantity_feature_percentage("Sex", data_folderpath, NUM_CLIENTS, PERC, SEED)
        ...
        with open(path, 'a') as file:
            file.write(f'Results Experiments 15 (seed {SEED}) \n')
            file.write('-'*40)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='results/results_experiments_15.txt', help='Path to save the results')
